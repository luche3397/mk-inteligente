  ...
  return (
    <div className="flex h-full min-h-0 flex-col p-5">
      <div className="mb-5 flex items-center justify-between gap-4 rounded-[28px] border border-[#2a2f3a] bg-white/[0.045] px-5 py-4 shadow-[0_24px_80px_rgba(0,0,0,0.2)] backdrop-blur-xl">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-[#a1a1aa]">Biblioteca Publica</p>
          <h3 className="mt-1 text-lg font-semibold text-white">Modulos HTML compartilhados</h3>
        </div>
